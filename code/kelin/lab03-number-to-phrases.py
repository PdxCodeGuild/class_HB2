...
hundred_ten = {'11': 'ten', '12':'twenty', '13':'thirty', '14':'forty', '15':'fifty', '16':'sixty', '17':'seventy', '18':'eighty', '19':'ninety'}
two_hundred_ten = {'21': 'ten', '22':'twenty', '23':'thirty', '24':'forty', '25':'fifty', '26':'sixty', '27':'seventy', '28':'eighty', '29':'ninety'}
three_hundred_ten = {'31': 'ten', '32':'twenty', '33':'thirty', '44':'forty', '35':'fifty', '36':'sixty', '37':'seventy', '38':'eighty', '39':'ninety'}
four_hundred_ten = {'41': 'ten', '42':'twenty', '43':'thirty', '44':'forty', '45':'fifty', '46':'sixty', '47':'seventy', '48':'eighty', '49':'ninety'}
five_hundred_ten = {'51': 'ten', '52':'twenty', '53':'thirty', '54':'forty', '55':'fifty', '56':'sixty', '57':'seventy', '58':'eighty', '59':'ninety'}
six_hundred_ten = {'61': 'ten', '62':'twenty', '63':'thirty', '64':'forty', '65':'fifty', '66':'sixty', '67':'seventy', '68':'eighty', '69':'ninety'}
seven_hundred_ten = {'71': 'ten', '72':'twenty', '73':'thirty', '74':'forty', '75':'fifty', '76':'sixty', '77':'seventy', '78':'eighty', '79':'ninety'}
eight_hundred_ten = {'81': 'ten', '82':'twenty', '83':'thirty', '84':'forty', '85':'fifty', '86':'sixty', '87':'seventy', '88':'eighty', '89':'ninety'}
nine_hundred_ten = {'91': 'ten', '92':'twenty', '93':'thirty', '94':'forty', '95':'fifty', '96':'sixty', '97':'seventy', '98':'eighty', '99':'ninety'}
...
elif user_num in range (100, 100, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
...
elif user_num in range (200, 300, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = two_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (300, 400, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = three_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (400, 500, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = four_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (500, 600, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = five_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (600, 700, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = six_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (700, 800, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = seven_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (800, 900, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = eight_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (900, 1000, 10):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    tens_phrase = str(tens)
    num_phrase_tens = nine_hundred_ten[tens_phrase]
    print(num_phrase_hundreds,num_phrase_tens)

elif user_num in range (100, 110, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (200, 210, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (300, 310, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (400, 410, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (500, 510, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (600, 610, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (700, 710, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (800, 810, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
...
elif user_num in range (900, 910, 1):
    hundreds_phrase = str(hundreds)
    num_phrase_hundreds = hundred[hundreds_phrase]
    ones_phrase = str(ones)
    num_phrase_ones = one[ones_phrase]
